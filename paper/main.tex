...
\begin{tabular}{@{}lr@{}}
\toprule
Metric / Characteristic & BoundedBufferClassifier \\
\midrule
...
Evaluation Partitioning & 30\% held-out eval, identical rows across all 3 conditions \\
...
\midrule
Incremental adaptation only (no GAN) & \textbf{0.1742} & \textbf{0.1575} & 0 \\
Incremental + GAN, ungated & 0.1738 & 0.1407 & 16,200 \\
Incremental + GAN + fidelity gate (full pipeline) & 0.1738 & 0.1507 & 3,600 \\
\bottomrule
\end{tabular}
\end{table}
